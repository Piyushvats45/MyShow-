          ...
          {nowPlayingMovies.map((movie)=>(
            <div key={movie.id} className={`relative max-w-40 cursor-pointer group-hover:not-hover:opacity-40 hover:-translate-y-1 transition duration-300`} onClick={()=> setSelectedMovies(movie.id)}>
              <div className='relative rounded-lg overflow-hidden'>
                ...
                <div className='flex text-sm items-center justify-between p-2 bg-black/70 w-full absolute bottom-0 left-0'>
              ...
              {selectedMovies === movie.id && (
                <div className='absolute top-3 right-2 flex items-center justify-center bg-primary h-6 w-6 rounded'>
